  ...
  landing: {
    ...
    showcase: {
      ...
      aiConversation: {
        ...
        stepOneLabel: "Tổng hợp ngữ cảnh",
        stepOneBody:
          "Giá, hoạt động spot, vị thế phái sinh và sự kiện vĩ mô sắp tới.",
        stepTwoLabel: "Chuẩn hóa và đối chiếu",
        stepTwoBody:
          "So sánh snapshot 7 ngày với 7 ngày trước; giữ funding theo kỳ 8 giờ.",
        stepThreeLabel: "Kiểm tra chéo",
        stepThreeBody:
          "Tách bằng chứng đồng thuận khỏi chỉ số hai chiều hoặc còn thiếu dữ kiện.",
        stepFourLabel: "Xây dựng kịch bản",
        stepFourBody:
    ...
    finalCta: {
      ...
      body: "Đăng ký để xem Signapse có thể phù hợp với quy trình theo dõi, nghiên cứu và tự động hóa của bạn như thế nào.",
      accessLabel: "START WITH YOUR MARKET WORKFLOW",
      nameLabel: "Họ và tên",
      namePlaceholder: "Nguyễn Văn A",
      emailLabel: "Email công việc",
      emailPlaceholder: "you@company.com",
      needLabel: "Nhu cầu chính",
      needMarketIntelligence: "Market intelligence",
      needTelegram: "Tín hiệu & Telegram",
      needStrategy: "Coding chiến lược & chỉ báo",
      needAutomation: "Bot & tự động hóa",
      needTeam: "Giải pháp cho đội ngũ/quỹ",
      submit: "Đăng ký xem demo",
      emailSubject: "Yêu cầu demo Signapse",
      preparingEmail: "Đang mở email để bạn gửi yêu cầu demo.",
      formNote: "Thông tin sẽ được điền vào email yêu cầu demo của bạn.",
    },
    footer: {
      description:
