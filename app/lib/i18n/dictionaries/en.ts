  ...
  landing: {
    ...
    showcase: {
      ...
      aiConversation: {
        ...
        stepOneLabel: "Collect context",
        stepOneBody:
          "Price, spot activity, futures positioning, and the next macro event.",
        stepTwoLabel: "Normalize & compare",
        stepTwoBody:
          "Compare this 7-day snapshot with the prior 7 days; keep funding at an 8-hour interval.",
        stepThreeLabel: "Cross-check",
        stepThreeBody:
          "Separate confirming evidence from two-sided or incomplete metrics.",
        stepFourLabel: "Build scenarios",
        stepFourBody:
    ...
    finalCta: {
      ...
      body: "Register to see how Signapse can fit your monitoring, research, and automation workflow.",
      ...
      needTelegram: "Signals & Telegram",
      needStrategy: "Strategy & indicator coding",
      needAutomation: "Bots & automation",
      needTeam: "Team or fund solution",
      submit: "Book a demo",
      emailSubject: "Signapse demo request",
      preparingEmail: "Opening your email to send the demo request.",
      formNote: "Your information will be added to a demo-request email.",
    },
    footer: {
      description:
