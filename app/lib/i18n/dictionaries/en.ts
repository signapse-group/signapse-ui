...
export const en: Dictionary = {
  ...
  feedback: {
    ...
    composeDescription:
      "Share a clear bug report or idea with the Signapse team.",
    typeLabel: "Feedback type",
    typeBug: "Bug",
    typeIdea: "Idea",
    types: { BUG: "Bug", IDEA: "Idea" },
    titleLabel: "Title",
    titlePlaceholder: "Summarise the issue or idea",
    descriptionLabel: "What happened?",
    descriptionPlaceholder: "Describe the problem or opportunity in detail",
    expectedOutcomeLabel: "Expected outcome",
    expectedOutcomePlaceholder: "What would a useful outcome look like?",
    reproductionStepsLabel: "Reproduction steps (optional)",
    reproductionStepsPlaceholder: "List the steps someone can follow",
    titleRequired: "Enter a title.",
    titleTooShort: "Title must be at least 5 characters.",
    titleTooLong: "Title cannot exceed 150 characters.",
    descriptionRequired: "Enter a description.",
    descriptionTooShort: "Description must be at least 20 characters.",
    descriptionTooLong: "Description cannot exceed 5000 characters.",
    expectedOutcomeRequired: "Enter the expected outcome.",
    expectedOutcomeTooShort: "Expected outcome must be at least 10 characters.",
    expectedOutcomeTooLong: "Expected outcome cannot exceed 3000 characters.",
    reproductionStepsTooLong:
      "Reproduction steps cannot exceed 5000 characters.",
    ...
    historyEmptyDescription:
      "Send your first bug report or idea to help improve Signapse.",
    ...
    detailExpectedOutcome: "Expected outcome",
    ...
    noGithubIssue: "No GitHub issue reference.",
    ...
    queueSearchLabel: "Search feedback titles",
    queueSearchPlaceholder: "Search titles…",
    ...
    queueSortTitleAsc: "Title A–Z",
    queueSortTitleDesc: "Title Z–A",
    queueAllTypes: "All types",
    ...
    promoteTitle: "Promote this feedback?",
    dismissTitle: "Dismiss this feedback?",
